...
**Date:** 2026-05-21 (initial) | **Revised:** 2026-05-26 (catch-up pass, batches B1–B5 complete; analysis review framework applied, 14 corrections) | 2026-05-27 (second review pass: Triggering Events & Shifts and Sales Analysis sections added; 6 further corrections applied)
...
**Sales priority:** **Adjacent entry [Medium].** CPMS confirmed proprietary in-house (ICSP Tier 1) — core CPMS replacement is structurally blocked; the only clearing path is an adjacent capability entry. V2G energy settlement tooling is the single Clearing adjacent candidate, forced by the Den Haag municipal concession contractual V2G-ready station obligation and the Volkswagen scaling pilot maturation timeline (2026–2027 window).
Trigger: Stack 1 (V2G Commercial Settlement + Concession SLA Exposure at Scale) is the active forcing mechanism — the window is the Volkswagen pilot maturation timeline (2026–2027) before in-house V2G settlement decisions lock in. Observable activation signals: a job posting for V2G settlement or grid services API integration at Vattenfall InCharge; a press release announcing V2G commercial launch in NL/SE with no settlement partner named; or a procurement notice for energy management or grid API tooling. Stack 2 (AFIR enforcement + payment failure persistence + concession SLA) would activate a core platform conversation if a Dutch regulatory enforcement action is issued — Low confidence, watch but do not act on alone.
...
**Entry point if pursued:** V2G energy dispatch and settlement capability — not a CPMS pitch. Vattenfall is running V2G pilots at commercial scale (200 Volkswagen EVs in SE, April 2026; NL V2G-ready stations at Den Haag written into concession specification). The settlement layer required to operate V2G commercially — energy dispatch to spot-price signals, grid operator API integration (TenneT NL, Svenska Kraftnät SE), and session-level energy accounting for bidirectional flows — sits outside ICSP's designed scope. This is a capability adjacent to their in-house CPMS, not a replacement of it. The entry conversation is: "how do you settle bidirectional energy transactions commercially under your Den Haag concession obligations?" — not "here is a better charging management platform." Window: 2026–2027, before the Volkswagen pilot completes and Vattenfall locks in its internal V2G settlement architecture.
...
| Category | Status |
|----------|--------|
| 1. Vendor Reliability | ✓ All N/A — CPMS is proprietary in-house (ICSP); no commercial CPMS vendor dependencies identified. No Easee hardware in corpus. Plugsurfing is a DE roaming partner (eMSP role only, not a CPMS dependency). |
| 2. Regulatory | ✓ Scanned. AFIR payment terminals (NL/DE): Latent. AFIR/EPBD IV building mandates (NL): Active. PBL (SE): Active. GEIG (DE): Active. Eichrecht (DE): N/A — compliant. NEVI/OZEV: N/A — EU-only operator. |
| 3. Contract & Procurement | ✓ All N/A — CPMS is in-house (no contract renewal window). InCharge is a tender winner, not a CPMS procurement target. |
| 4. Stage Transition | ✓ Stage 3→4: Multi-market regulatory compliance burden Active; white-label B2B client integration Active. Stage 4 ongoing: V2G adjacent capability Active. |
| 5. Archetype-Specific (Dominant Utility) | ✓ Payment failure persistence (2020–2026) across SE/NL/DE: Latent — above ≈2.5★ aggregate threshold, near-threshold for Dominant Utility disposition. |
| 6. Strategic & Capital | ✓ All checked, none fired — 100% Swedish state ownership, no funding change, no ownership change, no restructuring, no CEO change signal, no M&A acquisition intent in corpus. |
| 7. Operational Quality | ✓ App quality: Latent — 4.35★ Android above threshold but persistent payment failure negative tail. Network reliability: Latent — partial signals, not confirmed estate-wide. Tech obsolescence: N/A — ISO 15118 / OCPP 2.0.1 confirmed via Den Haag pilot. |
| 8. Emerging Revenue | ✓ V2G Commercial Settlement: Active. Concession SLA Exposure at Scale: Active. Specialist Operator Divestiture: Completed Dec 2025 (Voltiva deal — past event). Loyalty/ecosystem gap: N/A. JV platform mandate: N/A. CPMS fragmentation from M&A: N/A. |
| 9. Triggers To Be Added | ✓ Scanned. No new trigger patterns observed in this company's corpus that are absent from the catalogue. |

---

### Active triggers

| Trigger | Category | Corpus evidence | Date |
|---------|----------|-----------------|------|
| AFIR/EPBD IV building mandates — B2B site host pipeline | Regulatory (§2) | NL: EPBD IV requirements referenced explicitly in InCharge NL marketing; written into municipal concession specifications. SE: PBL (Jan 2025) for buildings >20 parking spaces, explicitly used in InCharge SE location-partner pitch (pages 5–6 SE operator services). | Active since Jan 2025 (SE PBL); EPBD IV NL ongoing |
| GEIG building mandate — B2B site host conversion (DE) | Regulatory (§2) | InCharge DE publishes GEIG advisory knowledge hub; location partner pitch explicitly references German building law. Confirmed active in corpus (GEIG advisory page). | Active since GEIG in force (2023) |
| Stage 3→4 multi-market regulatory compliance burden | Stage Transition (§4) | Eichrecht (DE) + AFIR (NL/DE) + PBL (SE) + ISO 55001 (NL, June 2025) + ISO 15118 (NL pilot, 2025) all simultaneously active. White-label eMSP confirmed: Louwman/Toyota-Lexus NL (2020), Volkswagen We Charge integration (2022). | Active — multi-market regulatory stack live as of 2025 |
| Stage 4 ongoing: V2G requiring adjacent capability | Stage Transition (§4) | Two V2G pilot announcements within 4 months: Hudiksvall housing association grid balancing (Jan 2026); Volkswagen 200-car scaling pilot (Apr 2026). Den Haag V2G-ready stations in NL concession spec already live. Confirmed in Transition pressures table. | Active as of Jan 2026 |
| V2G Commercial Settlement | Emerging Revenue (§8) | Volkswagen pilot (200 EVs, Apr 2026, SE) with Energy Bank (commercial partner — no academic partner or EU Horizon acknowledgment named). Hudiksvall housing grid balancing (Jan 2026). Den Haag V2G-ready stations written into NL concession specification (contractual, not research). Multiple markets (SE + NL), multiple vehicle/site types, commercially structured pilots. Named example in triggering events catalogue. | Active as of Jan 2026 (first pilot); Apr 2026 (scaling) |
| Concession SLA Exposure at Scale | Emerging Revenue (§8) | 60,000+ NL CPs under 10–15 year municipal concessions (Brabant+Limburg 22K, Den Haag 8.6K, Amsterdam Metro area 35K). 8M charging sessions in 2025 (+68% YoY). ISO 55001 certification (June 2025) signals contractual SLA compliance posture. Named example in triggering events catalogue. | Active — NL concession obligations commenced at tender award (2022–2024) |

---

### Latent triggers (monitoring)

| Trigger | Why latent | Activation observable |
|---------|------------|----------------------|
| AFIR payment terminal compliance (NL DC estate) | Den Haag Plug & Charge pilot live — remediation in progress. Full NL DC estate compliance not confirmed in corpus. Compliance direction is correct but scope unclear. | InCharge announcement confirming AFIR-compliant open payment across all NL DC public infrastructure; OR Dutch regulatory enforcement notice against any Dutch CPO establishing enforcement is active |
| Dominant Utility archetype trigger — payment failure persistence | 4.35★ Android average is above the ≈2.5★ formal trigger threshold. Dominant Utility tolerance for platform issues is higher than pure-play CPOs — staying must become more painful than switching. Payment failures are documented but have not forced a response in 6 years. | AFIR enforcement notice specifically citing payment compliance failures; OR a Dutch provincial authority citing concession SLA breach in connection with authentication/payment failures; OR aggregate Android rating falls to ≈3.0★ or below |
| App quality — payment failure negative tail | Same basis as above. Aggregate 4.35★ does not meet formal trigger threshold. The chronic payment failure pattern (2020–2026, SE/NL/DE users) is more diagnostic than the aggregate implies — but formal trigger requires the aggregate threshold. | Aggregate Android rating falls to ≈3.5★ or below; OR a named institutional or B2B client publicly cites InCharge payment issues as a service concern; OR a NL-market regulatory complaint specifically names payment reliability |

---

### Trigger stacks → shift hypotheses

#### Stack 1 — V2G settlement layer decision forced by NL concession obligations and SE pilot maturation, 2026–2027

**Named triggers (both load-bearing):**

1. **V2G Commercial Settlement** (Active, §8): Simultaneously operating commercially-structured V2G pilots across multiple markets (SE: Volkswagen 200-car scaling pilot with Energy Bank, Apr 2026; NL: Den Haag V2G-ready concession requirement, ISO 15118 live pilot, 2025) and multiple site types (private fleet + housing association + municipal concession).

2. **Concession SLA Exposure at Scale** (Active, §8): 60,000+ NL CPs under 10–15 year municipal concessions with contracted performance obligations; 8M sessions/year; V2G-readiness is a written concession deliverable at Den Haag.

**Load-bearing test:** Remove V2G Commercial Settlement → Concession SLA alone creates platform reliability pressure but not specifically a V2G settlement gap; the shift loses specificity. Remove Concession SLA → V2G Commercial Settlement creates a capability demand, but without contractual obligation it is deferrable as an internal product decision. Both are load-bearing; the Stage 4 V2G adjacent-capability signal corroborates trigger 1 but is redundant with it and was removed from the stack.

**Causal mechanism:** The NL concession specifications (Den Haag, 2025) explicitly require V2G-ready stations — bidirectional charging capability is a contractual deliverable, not aspirational. As the Volkswagen pilot matures and InCharge attempts commercial V2G deployment in NL and SE, the required settlement layer — energy dispatch to spot-price signals, grid operator API integration (TenneT NL, Svenska Kraftnät SE), and session-level energy accounting — sits outside what a session-management CPMS provides. InCharge's ICSP manages charging sessions; V2G settlement is an adjacent capability. A failure to deliver this settlement functionality to NL concession specification is a contractual breach. Trigger 1 creates the capability demand; trigger 2 elevates it from an internal product decision to a contractual obligation with financial liability. Neither trigger alone crosses the Dominant Utility forcing threshold at this urgency level; together they force the adjacent-capability decision.

**Shift:** V2G settlement layer decision — what adjacent capability (internal build extension of ICSP, or third-party integration) handles energy dispatch, grid operator API, and settlement for commercial V2G under NL concession performance obligations.

**Timing anchor:** Den Haag V2G-ready stations already live (2025, anchor: concession obligation commenced). Volkswagen pilot described as "scaling" (April 2026, anchor: commercial transition intended within the pilot lifecycle). Window: 2026–2027, before the NL concession V2G performance window and Volkswagen pilot completion lock in internal decisions.

**Confidence: Medium**
- *What would raise it:* A job posting for "energy dispatch engineer," "V2G settlement architect," or "grid services API integration" at Vattenfall/InCharge; a procurement notice for energy management or V2G settlement tooling; or a press release announcing V2G commercial launch in NL/SE with no settlement partner named.
- *What would lower it:* A careers page or press release confirming InCharge is building V2G settlement capability as an in-house extension of ICSP; or a named partnership with an existing energy management / V2G platform provider announced publicly.

---

#### Stack 2 — AFIR enforcement forcing payment compliance remediation under NL concession SLA, conditional on enforcement action 2026

**Named triggers (all three load-bearing):**

1. **AFIR payment terminal compliance** (Latent, §2): Open payment at DC ≥50kW required from 2025; Den Haag Plug & Charge pilot addresses a subset of the NL DC estate; full compliance not confirmed.

2. **Dominant Utility archetype trigger — payment failure persistence** (Latent, §5): Payment failures documented in app reviews 2020–2026 across SE/NL/DE users; aggregate 4.35★ above formal threshold; not yet at Dominant Utility forcing point.

3. **Concession SLA Exposure at Scale** (Active, §8): Long-duration NL municipal concessions with contracted performance obligations; 8M sessions/year.

**Load-bearing test:** Remove AFIR — payment failures + SLA tell a chronic reliability story but without a specific compliance mechanism to force action; the Dominant Utility can absorb this indefinitely. Remove payment failure persistence — AFIR + SLA create compliance/liability framing, but the underlying CPMS-level problem is unproven; stack can be dismissed as "InCharge is addressing this." Remove Concession SLA — AFIR + payment failures create compliance pressure without contractual liability; Dominant Utility threshold not crossed. All three load-bearing. Note: two of three are Latent — confidence is Low; this stack is conditional.

**Causal mechanism:** InCharge NL's municipal concession contracts likely include payment performance and availability SLAs — ISO 55001 certification and the Netbewust Laden pilot both signal contractual compliance seriousness. AFIR requires demonstrable open payment at DC ≥50kW from 2025. The payment failure pattern (2020–2026, SE/NL/DE users) establishes that a systemic billing integration issue at the CPMS level has persisted across markets for six years without resolution. If an AFIR enforcement action were taken against InCharge — or a Dutch provincial authority issued a formal SLA notice citing payment compliance failures — the Dominant Utility tolerance threshold would be crossed for the first time. These three triggers compound: AFIR creates a specific legal compliance mechanism; payment failure persistence proves the underlying system issue is real and multi-year; concession SLA converts the regulatory exposure into financial contractual liability. No individual trigger forces the decision; together they would.

**Shift:** Core platform remediation decision — specifically the CPMS-level payment gateway / billing integration layer — forced by regulatory enforcement converting a chronic operational issue into a contractual breach.

**Timing anchor:** AFIR compliance for DC ≥50kW: new stations from April 2024; full estate (new + existing) compliance deadline January 2026. As of analysis date (May 2026), the compliance deadline has passed — enforcement is technically actionable now. Stack is conditional: the activation event is a publicly reported Dutch regulatory enforcement action against any Dutch CPO for AFIR payment non-compliance. No confirmed enforcement date can be stated without this event.

**Confidence: Low**
- *What would raise it:* Dutch regulator (ACM or equivalent) issuing an enforcement notice against any Dutch CPO for AFIR payment non-compliance; InCharge announcement confirming full NL DC estate AFIR compliance; NL app review frequency of payment failure complaints increasing in 2026 relative to prior years.
- *What would lower it:* InCharge press release confirming AFIR compliance across the full NL DC network; or confirmation that the Plug & Charge pilot has been extended across all InCharge NL DC infrastructure; or aggregate Android rating improving notably in 2026 (suggesting payment reliability improving).

---

### No-stack verdict

The following Active triggers did not compound into a shift hypothesis for a CPMS-relevant forced decision:

- **AFIR/EPBD IV building mandates / PBL (SE) / GEIG (DE)** — These are regulatory opportunity signals that InCharge is already exploiting as B2B site host conversion tools (GEIG advisory hub in DE, PBL framing in SE, EPBD IV in NL marketing). No platform gap created — InCharge is compliant and actively using the regulatory environment as competitive advantage. No platform forcing event.

- **Stage 3→4 multi-market regulatory compliance burden** — InCharge is managing Eichrecht + AFIR + PBL + ISO 55001 + ISO 15118 simultaneously. This is the context of a mature Stage 4 operator, not a signal of inability to comply. The ISO 55001 certification and Den Haag Plug & Charge pilot both confirm compliance investment is active. No single compliance burden is identified as one InCharge cannot meet without a CPMS change.

These signals inform InCharge's competitive position and regulatory sophistication. They do not individually force a platform decision at Dominant Utility threshold.

---

### Feeds to Synthesis

**Proposed revision to Synthesis `Trigger:` field:**

> "Trigger: Stack 1 (V2G Commercial Settlement + Concession SLA Exposure) is the active forcing mechanism — the window is the Volkswagen pilot maturation timeline (2026–2027) before in-house V2G settlement decisions lock in. Observable activation signals: a job posting for V2G settlement or grid services API integration at Vattenfall InCharge; a press release announcing V2G commercial launch in NL/SE with no settlement partner named; or a procurement notice for energy management or grid API tooling. Stack 2 (AFIR enforcement + payment failure persistence + concession SLA) would activate the core platform conversation if a Dutch regulatory enforcement action is issued — Low confidence, watch but do not act on alone."

**Proposed addition to Synthesis `Where this is going:` field:**

> "V2G will require an energy management layer adjacent to ICSP by 2027 at the latest — the NL concession contractual obligations (Den Haag V2G-ready stations) and the Volkswagen pilot maturation timeline make this a forced decision, not a roadmap choice. The AFIR compliance and payment failure stack is real but conditional on enforcement materialising; it is a watch signal, not a near-term window."

*Note: These are proposals for the analyst to integrate on the final compression pass — not applied to the Synthesis directly.*
...
Vattenfall InCharge operates a confirmed proprietary in-house CPMS (ICSP — InCharge Service Platform), confirmed Tier 1 via WSO2 IAM on own domain, `isSaaSApp=false`, `sp=ICSP`, and `tenantDomain=int.incharge`. There is no prior platform switch — InCharge has never been on a third-party CPMS; ICSP predates the InCharge brand (Nuon `nl.nuon.laadpunten` legacy). Switching CPMS means an organizational decision by Vattenfall AB's energy division to stop investing in an in-house platform that the engineering team owns — a political and economic commitment against 10+ years of in-house build. Full re-integration scope would include: WSO2 IAM (own domain), Enexis DSO API integration (grid-aware charging, live at ≈800 NL stations), Eichrecht-compliant metering layer (DE), ISO 15118 / Plug & Charge (NL pilot live), EasyPark (SE/NL), Hubject eRoaming, ChargePanel OCPI, E.ON roaming (SE), Plugsurfing DE, and multi-brand hardware estate (ABB, Kempower, KEBA, Autel, Alfen, XCharge). Threshold for any CPMS conversation: Very High. Adjacent-capability candidates are the only realistic entry — evaluated below under the adjacent-capability exception. No acquired brands running separate CPMS stacks; no co-primary gate applies.
...
|-----------|--------|-----------|-------------------|--------|------------------------------------|----------|---------|
| V2G energy dispatch / settlement layer | Stress map (Stage 4 V2G) + Trigger (Stack 1: V2G Commercial Settlement + Concession SLA) + Gaps table | BMO + BR (Adjacent) | Adjacent — ICSP handles session management; energy dispatch, grid API, V2G settlement are outside ICSP's design scope | Yes — NL concession V2G-ready obligation at Den Haag (3,200 CPs, 2025) + Volkswagen pilot scaling (200 EVs, Apr 2026) | Denominator: NL concession V2G-ready CPs + Volkswagen pilot fleet. Concession SLA obligation is T1-evidenced; commercial V2G revenue figure not in corpus. Adjacent-capability exception: T2 magnitude acceptable given T1 mechanism. Commercial maturity confirmed (Voltiva generating grid balancing revenue from Svenska Kraftnät — comparable peer, structurally replicable via Vattenfall's Enexis DSO API and grid parent) | T1 mechanism / T2 magnitude | Clears (Adjacent) |
| Payment gateway reliability | Gaps table + App reviews (2020–2026) | BP | In-house ICSP quality issue — adjacent exception does not apply cleanly (capability exists, quality is poor; not a structural gap) | Yes | T2 — 8M NL sessions/year; failure rate estimated from review frequency; financial figures not in corpus. Does not meet adjacent-capability exception: the issue requires replacing/fixing the ICSP payment integration layer, which is internal | T1 mechanism / T2 magnitude | Doesn't clear — Very High proprietary threshold; internal fix required |
| Enterprise cross-market billing (SE+NL+DE) | Gaps table (Unclear) | — | Unclear | Unclear | T3 — corpus could not determine whether the gap exists; no international fleet client citing the need | T3 | Doesn't clear — T3 evidence |
| Concession SLA platform reliability (NL scale) | Trigger (Stack 1 component) + Stress map | BR | Yes — ICSP is the session management layer for all NL concession CPs | Yes | T1 exposure / T2 trajectory — concession contracts confirmed T1 (press releases); SLA breach path T2 (Dec 2023 crisis + payment failures are evidence of ICSP estate-wide risk, not confirmed current breach) | T1/T2 | Captured in V2G settlement candidate (severity multiplier for BR category) — not a standalone clearing candidate |
| White-label sub-operator integration | Stress map (Stage 3→4) | — | Yes | Unclear | Not yet visible — capability already demonstrated (Louwman/Toyota-Lexus NL 2020, VW We Charge 2022); no evidence of strain at current scale | T2 (capability), T3 (strain) | Doesn't clear — no strain evidenced |
| AFIR payment compliance (NL DC estate) | Trigger (Stack 2 conditional) + Regulatory | BP + BR (Adjacent, Conditional) | Adjacent — requires AFIR-compliant contactless payment terminal integration in ICSP | Yes | T2 — NL DC estate extent not fully known; Den Haag pilot addresses subset; AFIR enforcement is active from 2025 | T1 mechanism (AFIR confirmed; payment failure pattern T1) / T2 magnitude | Conditional on [AFIR enforcement notice against a Dutch CPO publicly reported] |

---

### Archetype filter applied

**Dominant Utility disposition:** "Concession threat or regulatory exposure outweigh everything else. Cost or efficiency arguments rarely clear without one of the above."

- **V2G settlement layer (Candidate 1):** Archetype filter moves priority **up** — this candidate maps directly to concession obligation (the highest-weight trigger class for a Dominant Utility). The concession SLA breach risk makes this a contractual forcing event, not a feature request. Lead candidate confirmed.
- **AFIR compliance (Candidate 6):** Archetype filter maintains Secondary — regulatory exposure is high-weight, but conditional status limits near-term actionability. Watch signal.
- **No ranking inversions** from Step B ordering. All other candidates correctly below clearing threshold under Dominant Utility disposition.

---

### Ranked entry points

1. **V2G energy dispatch and settlement layer** — BMO + BR (Adjacent). Clears outright.

   The NL concession specification at Den Haag (2025) contractually requires V2G-ready station operation — bidirectional energy service delivery is a concession SLA obligation, not an aspiration. ICSP manages charging sessions; energy dispatch to spot-price signals (TenneT NL, Svenska Kraftnät SE), grid operator API integration, and session-level energy settlement are adjacent capabilities that sit outside ICSP's designed scope. Voltiva (operating InCharge's divested SE residential portfolio on Mobility46 CPMS) is already generating commercial grid balancing revenue from Svenska Kraftnät — the commercial precedent exists within InCharge's own prior network, structurally replicable given Vattenfall's live Enexis DSO API (Netbewust Laden pilot confirmed in corpus). If V2G settlement is not delivered to NL concession specification, the consequence is a contractual breach — not merely a missed revenue opportunity. The 2026–2027 window is open before the Volkswagen pilot (200 EVs, April 2026) completes and Vattenfall locks in its internal V2G settlement architecture.
   - **Trigger / confirming signal:** A job posting for "V2G settlement," "energy dispatch engineer," or "grid services API integration" at Vattenfall/InCharge; OR a press release announcing V2G commercial launch in NL/SE with no settlement partner named; OR a procurement notice for energy management or grid API tooling.
   - **Signal timing:** Near-term (under 12 months) — Den Haag V2G-ready stations live (2025); Volkswagen pilot in active scaling (April 2026).
   - **Candidate priority: Lead.**

2. **AFIR payment compliance remediation** — BP + BR (Adjacent). Conditional on [AFIR enforcement notice against a Dutch CPO publicly reported].

   AFIR requires demonstrable open payment at DC ≥50kW from 2025 across NL and DE. The payment failure pattern (2020–2026) is T1-evidenced as a chronic CPMS-level billing integration issue across three markets. Den Haag Plug & Charge pilot addresses a subset; full NL DC estate compliance unconfirmed. If AFIR enforcement begins against Dutch CPOs, InCharge's documented payment failures under NL concession SLAs would convert from an app review complaint into a regulatory compliance breach. The Dominant Utility threshold for platform action would be crossed. The adjacent entry is contactless terminal integration or alternative payment processor routing — an add-on to ICSP rather than a replacement. For a Dominant Utility, this conversation opens only under regulatory compulsion.
   - **Trigger / confirming signal:** Dutch regulator (ACM or equivalent) issuing an enforcement notice against any Dutch CPO for AFIR payment non-compliance; OR InCharge announcing full NL DC estate AFIR compliance (resolves the candidate in InCharge's favour).
   - **Signal timing:** Near-to-medium term (AFIR enforcement active from 2025; first Dutch enforcement actions plausible in 2026).
   - **Candidate priority: Secondary — watch signal.**

---

### Verdict

**Adjacent entry [Medium]** — ICSP is confirmed proprietary in-house (Tier 1), making core CPMS replacement structurally blocked; the single Clearing adjacent candidate (V2G settlement) is forced specifically by the Den Haag municipal concession contractual V2G obligation and the Volkswagen scaling pilot timeline — not generic platform dissatisfaction — with T2 magnitude preventing a High verdict.

---

### Feeds to Synthesis

- **Synthesis `Sales priority:` candidate:** Adjacent entry [Medium] — CPMS confirmed proprietary in-house (ICSP Tier 1), core replacement blocked; the single credible adjacent entry is V2G energy settlement tooling forced by the Den Haag concession contractual V2G obligation and the Volkswagen SE scaling pilot (2026–2027 window).
- **Synthesis `Entry point if pursued:` candidate:** V2G energy dispatch and settlement capability adjacent to ICSP — not a CPMS replacement. Frame the conversation around how InCharge settles bidirectional energy transactions commercially (TenneT NL, Svenska Kraftnät SE) under Den Haag concession obligations. Window: before the Volkswagen pilot completes and internal settlement architecture is locked in (2026–2027).
- **Synthesis `Adjacent leads:` candidate:** Voltiva / Mobility46 (SE) — 11,000 ex-Vattenfall residential/workplace CPs, Mobility46 CPMS, grid balancing revenue from Svenska Kraftnät; separate procurement from InCharge. Vattenfall Network Solutions (DK/NL) — Power-as-a-Service heavy fleet, depot management tooling potential, separate procurement entity from InCharge retail.
...
### Review corrections (Analysis Review Framework — 2026-05-27)

*Corrections applied following second review pass. Triggering Events & Shifts and Sales Analysis sections were absent from the analysis — produced by running the respective skills before Stage 1d and 1e checks could execute. Six corrections applied after Stages 1d, 1e, 2, and 3.*

- **Resolved F15** — Synthesis `Sales priority:` updated from "**Low**" to "**Adjacent entry [Medium]**" with company-specific reason per Feeds to Synthesis from Sales Analysis. Previous "Low" verdict predated the Sales Analysis section and was not updated on the initial pass. Core CPMS replacement remains structurally blocked; the adjacent V2G settlement entry is what clears.
- **Resolved F16** — Synthesis `Trigger:` field replaced with Stack 1 / Stack 2 framing per Feeds to Synthesis from Triggering Events & Shifts. Previous field listed generic conditions for a CPMS conversation; updated to name Stack 1 (V2G Commercial Settlement + Concession SLA Exposure) as the active forcing mechanism and Stack 2 (AFIR + payment failures + concession SLA) as a conditional Low-confidence watch signal.
- **Resolved F17** — Synthesis `Where this is going:` V2G forced-decision addition applied from Feeds to Synthesis: "V2G will require an energy management layer adjacent to ICSP by 2027 at the latest — the NL concession contractual obligations (Den Haag V2G-ready stations) and the Volkswagen pilot maturation timeline make this a forced decision, not a roadmap choice." Previous text characterised platform additions as a possible future need; updated to reflect that the concession obligation makes this forced.
- **Resolved F18** — Synthesis `Entry point if pursued:` updated with TenneT NL / Svenska Kraftnät SE grid operator naming, Den Haag concession obligation framing, and explicit 2026–2027 window, per Feeds to Synthesis from Sales Analysis.
- **Resolved F19** — Stack 2 AFIR timing anchor updated: the AFIR DC ≥50kW full-estate compliance deadline was January 2026, which has passed at analysis date (May 2026). Previous text said "effective from 2025" — imprecise. Updated to: "compliance deadline January 2026... enforcement is technically actionable now." Stack remains conditional on an enforcement action being publicly reported; the Dominant Utility forcing threshold requires the notice, not just the deadline.
- **Resolved F20 (minor)** — Typo in Sales Analysis Archetype filter section: "concessioin SLA" → "concession SLA".
